...
`ici <https://docs.wpilib.org/en/latest/docs/software/getting-started>`__.
...
`les instructions <https://docs.wpilib.org/en/latest/docs/software/driverstation/frc-update-suite.html>`__
